...
<table>
	...
	<c:forEach items="${list }" var="review">
		<tr>
			<td>${review.rev_code }</td>
			<td><a  class='move' href='<c:out value="${review.rev_code }"/>'>${review.rev_title }</a></td>
			<td>${board.username }</td>			
			<td><fmt:formatDate pattern="yyyy-MM-dd"
				value="${review.rev_regdate }" /></td>
...
<ul class="pagination">
	...
	<form id="searchForm" method="get" action="/review/list">
	<select name="type">
